  ...
  return (
    <section className="my-[80px] lg:flex gap-16">
      <div>
        ...
        <p className="text-[#666] text-[19px] lg:text-[22px] mb-16">Hi! I'm Abdullah, a Fullstack Web Developer based in Nigeria. I create user-friendly interfaces for fast-growing startups.</p>
